					...
					<form action="stuUpdate.jsp">
						<table>
							<tr>
								<th>학번</th>
								<td>
									<input type="number" name="idx" readonly value="<%=idx %>">
								</td>
							</tr>
							<tr>
								<th>국어</th>
								<td>
									<input type="number" name="kor" min=0 max=100 value=0>
								</td>
							</tr>
							<tr>
								<th>영어</th>
								<td>
									<input type="number" name="eng" min=0 max=100 value=0>
								</td>
							</tr>
							<tr>
								<th>수학</th>
								<td>
									<input type="number" name="math" min=0 max=100 value=0>
								</td>
							</tr>
							<tr>
								<td colspan="2">
